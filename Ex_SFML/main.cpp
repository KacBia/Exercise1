...
int main() {
    // create the window
    sf::RenderWindow window(sf::VideoMode(1000, 800), "dum dum dum");
    ...
    int rectangle_velocity_x = 450;
    int rectangle_velocity_y = 400;
    int rectangle_angular_velocity = 10;


    int triangle_velocity_x = 240;
    int triangle_velocity_y = 100;
    int triangle_angular_velocity = 35;


    int circle2_velocity_x = 240;
    int circle2_velocity_y = 400;

//    bool flag_y = false;
//    bool flag_x = false;

    sf::Music music;
       if (!music.openFromFile("a-hero-of-the-80s-126684.ogg"))
           return EXIT_FAILURE;
